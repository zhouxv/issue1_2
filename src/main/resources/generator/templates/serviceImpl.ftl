...
public class ${className}ServiceImpl extends ServiceImpl<${className}Mapper, ${className}> implements I${className}Service {
    ...
    public Boolean create${className}(${className} ${className?uncap_first}) {
    ...
    public Boolean update${className}(${className} ${className?uncap_first}) {
        return this.saveOrUpdate(${className?uncap_first});
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public Boolean delete${className}(${className} ${className?uncap_first}) {
